      ...
      <Box my={4}>
        ...
        <Paper style={{ padding: "20px", marginBottom: "20px" }}>
          <Typography variant="h4" gutterBottom>
            Welcome to MovieBrief!
          </Typography>
          <Typography paragraph>
            At MovieBrief, we are driven by a single goal: to enhance your
            ...
            movie to enjoy, MovieBrief is your go-to resource.
          </Typography>
        </Paper>
        ...
        <Paper style={{ padding: "20px", marginBottom: "20px" }}>
          ...
          <Grid container spacing={3}>
            <Grid item xs={12} sm={4}>
              ...
              <Typography paragraph>
                The visionary behind MovieBrief, Ahmad brings a wealth of
            ...
            <Grid item xs={12} sm={4}>
              ...
              <Typography paragraph>
                ...
                that MovieBrief is not only functional but also visually
                appealing and easy to navigate.
              </Typography>
            </Grid>
            <Grid item xs={12} sm={4}>
              <Typography variant="h6">Arina</Typography>
              <Typography paragraph>
                Our data guru, Arina, works tirelessly to ensure that the movie
                information on MovieBrief is accurate, up-to-date, and
                comprehensive.
              </Typography>
            </Grid>
          </Grid>
        ...
        <Paper style={{ padding: "20px", marginBottom: "20px" }}>
          ...
          <Typography paragraph>
            MovieBrief is more than just an application; it's a tool that
        ...
        <Paper style={{ padding: "20px" }}>
          ...
          <Typography paragraph>
            MovieBrief is a unique application designed for movie lovers and
          ...
          <Typography paragraph>
            ...
            inspire. MovieBrief is committed to enhancing your viewing
